...
import { TStateActions, TStoreReducers } from 'shared/utils/types';
...
export type TDataFetchingStoreActions<D> = CaseReducerActions<
  TStoreReducers<TDataFetchingState<D>, TActionPayload<D>>,
  string
>;
...
export type TDataFetchingSelectors<D> = {
  ...
  selectError: (
    state: TDataFetchingState<D>,
  ) => TDataFetchingStateError<ApiException>;
};
